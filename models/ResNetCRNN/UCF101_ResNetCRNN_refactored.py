#!/usr/bin/env python3
"""
Refactored ResNetCRNN Model for UCF101 Video Classification
使用公共组件的重构版本
"""
...
from common.model_components import ResCNNEncoder, DecoderRNN
...
class Config:
    # 数据路径
    data_path = None  # 从配置文件读取
    action_name_path = None  # 从配置文件读取
...
def train_model(config):
    """训练模型"""
    print("Starting ResNetCRNN training...")
    ...
    # 创建模型
    model = ResNetCRNNModel(config).to(device)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='ResNetCRNN Training')
    ...
    print("ResNetCRNN training completed successfully!")
